...
echo "Next Steps"
echo "========================================="
echo "1. Reproduce a crash with the kernel/QEMU command documented for the target:"
echo "   cargo run --manifest-path userspace/fuzzer/Cargo.toml --bin crash-triage -- --crash-dir $UNIQUE_DIR"
echo ""
echo "2. Debug with GDB:"
echo "   gdb --args kernel.elf < <crash_file>"
echo ""
echo "3. Keep the deduplicated inputs under:"
echo "   $UNIQUE_DIR"

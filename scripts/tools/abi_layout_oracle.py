...
Usage:
    python3 scripts/tools/abi_layout_oracle.py --self-test        # unit + negative tests
    python3 scripts/tools/abi_layout_oracle.py --check            # full gate (default)
    python3 scripts/tools/abi_layout_oracle.py --emit-c PATH      # dump the C leg only
Options:

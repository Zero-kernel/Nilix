...
from scripts.gates.qemu import namespace_resource_probe as probe
from scripts.gates.qemu.namespace_resource_probe import evidence_passes
...
class CollectorTests(unittest.TestCase):
    def run_fixture(self, change=None, phase=None, schema="current", sidecar="3"):
        with tempfile.TemporaryDirectory(prefix="namespace-collector-") as temporary:
            ...
            with patch.object(probe, "__file__", str(root / "scripts/gates/qemu/namespace_resource_probe.py")), \

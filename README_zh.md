...
**更新日期：2026-09-12**；代码基线 3254318，CI 总时间预算后续修正为 a84e963。
...
当前 hosted allowlist 在 debug/release 下分别执行 **437 次计数受检的单元测试**，
...
guest 观察窗口默认 **900 秒**，boot/runtime/SMP 组会依次运行三个窗口。

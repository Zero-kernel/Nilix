...
[private reporting form](https://github.com/Xero-Team/zpdf/security/advisories/new).

Prefix the report title with `Code of Conduct` so maintainers can route it
correctly. Reports will be reviewed promptly and fairly, and the privacy and
safety of the reporter will be respected.
